...
The contact hours of an student project depend heavily on the type of project.
A lab-based project requires lots of contact hours in the lab with the day-to-day supervisor.
Alternatively for a literature-based research project, or a community outreach project, there would likely be fewer contact hours, as the student would be less likely to set anything on fire. EDWARD ASKS: IS THIS FUNNY? WORTH INCLUDING? (it is true, yes, lab students do sometimes set things on fire.)
...
However, we were able to attend regular video meetings with our supervisors and with collaborators, and we posted frequent progress updates on the lab Slack messageboard.
...
It provided potential for learning a variety skills as we were free to aid in different sub-projects, in addition to your own, without concerns about confidentiality.
